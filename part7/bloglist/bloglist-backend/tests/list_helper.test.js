...
describe('favorite blog', () => {
  test('of list with no blogs', () => {
    expect(listHelper.favoriteBlog(noBlogs)).toEqual({});
  });
...
describe('most blogs', () => {
  test('of list with no blogs', () => {
    expect(listHelper.mostBlogs(noBlogs)).toEqual({});
  });
...
describe('most likes', () => {
  test('of list with no blogs', () => {
    expect(listHelper.mostLikes(noBlogs)).toEqual({});
  });
